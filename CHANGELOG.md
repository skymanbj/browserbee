...
- **Memory Management UI**: Comprehensive UI for viewing, editing, exporting, importing, and single/batch deleting website interaction memories.
- **Full Data Cloud Sync**: Supports secure cloud backups to Google Drive (via OAuth2) and WebDAV servers.
- **Smart Merge Sync**: Intelligent two-way merge for memories, prompts, tasks, and sessions to prevent data duplication.
